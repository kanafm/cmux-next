...
/// SwiftUI view that renders a MarkdownPanel's content via the shared
/// MarkdownPreviewView (WKWebView + bundled marked.min.js). Replaces the
/// older MarkdownUI-based renderer.
struct MarkdownPanelView: View {
    ...
    private var baseDirectoryURL: URL? {
        guard !panel.filePath.isEmpty else { return nil }
        return URL(fileURLWithPath: panel.filePath).deletingLastPathComponent()
    }
